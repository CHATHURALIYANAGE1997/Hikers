...
public class UserRestImpl implements UserRest {
    ...
    public ResponseEntity<?> volientier(Map<String, String> requestMap) {
        try{
            return userService.volientier(requestMap);
        }catch (Exception ex){
            ex.printStackTrace();
        }
        return new ResponseEntity(new ArrayList<>(), HttpStatus.BAD_REQUEST);
    ...
    public ResponseEntity<?> getvolientiers() {
        try{
            return userService.getvolientiers();
        }catch (Exception ex){
            ex.printStackTrace();
        }
        return new ResponseEntity(new ArrayList<>(), HttpStatus.BAD_REQUEST);
    ...
    public ResponseEntity<?> volientierprograms(Map<String, String> requestMap) {
        try{
            return userService.volientierprograms(requestMap);
        }catch (Exception ex){
            ex.printStackTrace();
        }
        return new ResponseEntity(new ArrayList<>(), HttpStatus.BAD_REQUEST);
    ...
    public ResponseEntity<?> getquestionsnew() {
        try{
            return userService.getquestionsnew();
        }catch (Exception ex){
            ex.printStackTrace();
        }
        return new ResponseEntity(new ArrayList<>(), HttpStatus.BAD_REQUEST);
    ...
    public ResponseEntity<?> addarticles(Map<String, String> requestMap) {
        try{
            return userService.addarticles(requestMap);
        }catch (Exception ex){
            ex.printStackTrace();
        }
        return new ResponseEntity(new ArrayList<>(), HttpStatus.BAD_REQUEST);
    ...
    public ResponseEntity<?> deletearticles(Long code) {
        try{
            return userService.deletearticles(code);
        }catch (Exception ex){
            ex.printStackTrace();
        }
        return new ResponseEntity(new ArrayList<>(), HttpStatus.BAD_REQUEST);
