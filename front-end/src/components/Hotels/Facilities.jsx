        ...
        <div>
            <div className="pb-3 hf-bg">
                <div className="bg-white hf-box">
                    ...
                    <h6>This is a paid facility for hotel guests with an admission fee.
                ...
                <div className="bg-white hf-box">
                    <h4 className="font-weight-bold">Billiard Boards</h4>
                ...
                <div className="bg-white hf-box">
                    <h4 className="font-weight-bold">Feast 365 - Restaurant</h4>
                ...
                <div className="bg-white hf-box">
                    <h4 className="font-weight-bold">Cloud 9 - Café</h4>
